...
const BetaLabel = () => (
  <span className="px-1.5 py-0.5 text-[10px] rounded-full bg-bolt-elements-item-backgroundAccent/10 text-bolt-elements-item-contentAccent font-medium">BETA</span>
);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {filteredTabs.some((tab) => DEFAULT_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-4 mb-2">
              <Icon name="star" size={16} className="text-bolt-elements-item-contentAccent" />
            ...
            .map((tab, index) => (
              ...
              >
                ...
                <div className="absolute top-1 right-1.5 flex gap-1">
                  <span className="px-1.5 py-0.25 text-xs rounded-full bg-bolt-elements-item-backgroundAccent/10 text-bolt-elements-item-contentAccent font-medium mr-2">
                    Default
                  </span>
                </div>
                ...
                <div className="flex items-start gap-4 p-4">
                  <motion.div
                    className={classNames(
                      ...
                      'transition-all duration-200',
                      tab.visible ? 'text-bolt-elements-item-contentAccent' : 'text-bolt-elements-textSecondary',
                    )}
                  ...
                  >
                    ...
                    >
                      <Icon name={TAB_ICONS[tab.id]} className="w-full h-full" />
                    </div>
                  </motion.div>
          ...
          {filteredTabs.some((tab) => OPTIONAL_USER_TABS.includes(tab.id)) && (
            <div className="col-span-full flex items-center gap-2 mt-8 mb-2">
              <Icon name="plus-circle" size={16} className="text-bolt-elements-item-contentAccent" />
