...
const BetaLabel = () => (
  <div className="absolute top-2 right-2 px-1.5 py-0.5 rounded-full bg-bolt-elements-item-backgroundAccent">
    <span className="text-[10px] font-medium text-bolt-elements-item-contentAccent">BETA</span>
  </div>
);
...
export const ControlPanel = ({ open, onClose }: ControlPanelProps) => {
  ...
  // Store values
  const tabConfiguration = useNanoStore(tabConfigurationStore);
  const developerMode = useNanoStore(developerModeStore);
  const profile = useNanoStore(profileStore) as Profile;
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-bolt-elements-borderColor">
                  <div className="flex items-center space-x-4">
                    {(activeTab || showTabManagement) && (
                      <button
                        onClick={handleBack}
                        className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-bolt-elements-item-backgroundActive group transition-all duration-200"
                      >
                        <Icon name="arrow-left" size={16} className="text-bolt-elements-textSecondary group-hover:text-bolt-elements-textPrimary transition-colors" />
                      </button>
                    )}
                  ...
                  <div className="flex items-center gap-6">
                    {/* Mode Toggle */}
                    <div className="flex items-center gap-2 min-w-[140px] border-r border-bolt-elements-borderColor pr-6">
                      <AnimatedSwitch
                        id="developer-mode"
                    ...
                    {/* Avatar and Dropdown */}
                    <div className="border-l border-bolt-elements-borderColor pl-6">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center w-8 h-8 rounded-full bg-transparent hover:bg-bolt-elements-item-backgroundActive group transition-all duration-200"
                    >
                      <Icon name="x" size={16} className="text-bolt-elements-textSecondary group-hover:text-bolt-elements-textPrimary transition-colors" />
                    </button>
                  </div>
                </div>
