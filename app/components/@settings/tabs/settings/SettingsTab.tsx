...
export default function SettingsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        className="bg-bolt-elements-background-depth-2 rounded-lg p-4 space-y-4 border border-bolt-elements-borderColor"
      ...
      >
        ...
        <div>
          ...
          <select
            ...
            className={classNames(
              ...
              'focus:outline-none focus:ring-2 focus:ring-bolt-elements-item-contentAccent/30',
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            <Icon name="bell" size={16} className="text-bolt-elements-textSecondary" />
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <Icon name="keyboard" size={16} className="text-gray-500" />
          <span className="text-sm font-medium text-bolt-elements-textPrimary">Keyboard Shortcuts</span>
        </div>

        <div className="space-y-2">
          <div className="flex items-center justify-between p-2 rounded-lg bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor">
            ...
            <div className="flex items-center gap-1">
              <kbd className="px-2 py-1 text-xs font-semibold text-bolt-elements-textSecondary bg-bolt-elements-background-depth-3 border border-bolt-elements-borderColor rounded shadow-sm">
