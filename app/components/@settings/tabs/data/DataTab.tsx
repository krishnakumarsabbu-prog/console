      ...
      <div>
        ...
        {dbLoading ? (
          <div className="flex items-center justify-center p-4">
            <Icon name="loader-2" size={24} className="animate-spin  mr-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  <motion.div className="text-bolt-elements-item-contentAccent mr-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                    <Icon name="download" size={20} className="" />
                  </motion.div>
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    className={classNames(
                      'hover:text-bolt-elements-item-contentAccent hover:border-bolt-elements-borderColorActive hover:bg-bolt-elements-item-backgroundAccent/5 transition-colors w-full justify-center',
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  <motion.div
                    className="text-bolt-elements-item-contentDanger mr-2"
              ...
              <CardFooter>
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    size="sm"
                    className={classNames(
                      'hover:text-bolt-elements-item-contentDanger hover:border-bolt-elements-item-backgroundDanger hover:bg-bolt-elements-item-backgroundDanger/5 transition-colors w-full justify-center',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
                <motion.div className="text-bolt-elements-item-contentAccent mr-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Icon name="filter" size={20} className="" />
                </motion.div>
                <CardTitle className="text-lg group-hover:text-bolt-elements-item-contentAccent transition-colors">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
                <motion.div className="text-accent-700 mr-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Icon name="upload" size={20} className="" />
                </motion.div>
                <CardTitle className="text-lg group-hover:text-bolt-elements-item-contentAccent transition-colors">
                  Import Settings
            ...
            <CardHeader>
              <div className="flex items-center mb-2">
                <motion.div
                  ...
                  whileTap={{ scale: 0.9 }}
                >
                  <Icon name="refresh-ccw" size={20} className="" />
                </motion.div>
                <CardTitle className="text-lg group-hover:text-bolt-elements-item-contentAccent transition-colors">
                  Reset All Settings
                </CardTitle>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
                <motion.div className="text-bolt-elements-item-contentAccent mr-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Icon name="file-text" size={20} className="" />
                </motion.div>
                <CardTitle className="text-lg group-hover:text-bolt-elements-item-contentAccent transition-colors">
                  Download Template
                </CardTitle>
