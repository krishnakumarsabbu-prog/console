...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    background: getThemeColor('--bolt-elements-background-depth-2'),
    accent: getThemeColor('--bolt-elements-item-contentAccent'),
  ...
  const getChartColors = (index: number) => {
    ...
    const baseColors = [
      // Indigo
      {
        base: getThemeColor('--bolt-elements-item-contentAccent'),
      },
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <Icon name="line-chart" size={48} className="mx-auto mb-4 text-bolt-elements-textTertiary opacity-80" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          ...
          <div className={statClasses}>
            <Icon name="message-square" size={32} className="text-bolt-elements-item-contentAccent" />
        ...
        <div className={cardClasses}>
          ...
          <div className={statClasses}>
            <Icon name="message-square-text" size={32} className="text-bolt-elements-item-contentAccent" />
        ...
        <div className={cardClasses}>
          ...
          <div className={statClasses}>
            <Icon name="bar-chart-2" size={32} className="text-bolt-elements-item-contentAccent" />
