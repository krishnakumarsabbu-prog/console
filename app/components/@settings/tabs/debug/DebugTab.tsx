    ...
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className="flex items-center gap-3">
          <Icon name="package" size={16} className="text-bolt-elements-textSecondary" />
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className={classNames(
              'caret-down w-4 h-4 transform transition-transform duration-200 text-bolt-elements-textSecondary',
              isOpen ? 'rotate-180' : '',
            )}
          />
        </div>
  ...
  const ExportButton = () => {
    ...
    return (
      <DialogRoot open={isOpen} onOpenChange={handleOpenChange}>
        ...
        >
          <Icon name="download" className="text-lg text-gray-500 dark:text-gray-400 group-hover:text-gray-500 transition-colors" />
          Export
        </button>
              ...
              {exportFormats.map((format) => (
                <button
                  ...
                  className={classNames(
                    ...
                    'hover:border-gray-200 dark:hover:border-gray-900/30',
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Errors Card */}
        <div className="p-4 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <Icon name="alert-octagon" size={16} className="text-gray-500" />
          ...
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <div
              className={classNames(
                'w-3.5 h-3.5',
                errorLogs.length > 0 ? 'warning text-red-500' : 'check-circle text-green-500',
              )}
            />
        ...
        <div className="p-4 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <Icon name="cpu" size={16} className="text-gray-500" />
          ...
          />
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <Icon name="info" size={12} className=".5 .5 text-gray-500" />
        ...
        <div className="p-4 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <Icon name="timer" size={16} className="text-gray-500" />
            ...
            <span
              className={classNames(
                ...
                (systemInfo?.performance.timing.loadTime ?? 0) > 2000
                  ? 'text-bolt-elements-item-contentDanger'
                  : (systemInfo?.performance.timing.loadTime ?? 0) > 1000
                    ? 'text-bolt-elements-item-contentWarning'
                    : 'text-bolt-elements-item-contentSuccess',
              )}
            >
          ...
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <Icon name="code" size={12} className=".5 .5 text-gray-500" />
        ...
        <div className="p-4 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <Icon name="wifi" size={16} className="text-gray-500" />
          ...
          <div className="text-xs text-bolt-elements-textSecondary mt-2 flex items-center gap-1.5">
            <Icon name="activity" size={12} className=".5 .5 text-gray-500" />
            RTT: {systemInfo?.network.rtt ?? '-'} ms
          </div>
        </div>

        {/* Ollama Service Card - Now spans all 4 columns */}
        <div className="md:col-span-4 p-6 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor transition-all duration-200 h-[260px] flex flex-col">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Icon name="bot" size={20} className="text-gray-500" />
              <div>
              ...
              <div className="flex items-center gap-2 px-2.5 py-1 rounded-full bg-bolt-elements-background-depth-3">
                <div
                  className={classNames('w-2 h-2 rounded-full animate-pulse', status.bgColor, {
                    'shadow-lg shadow-bolt-elements-item-backgroundSuccess/20': status.status === 'Running',
                    'shadow-lg shadow-bolt-elements-item-backgroundDanger/20': status.status === 'Not Running',
                  })}
                />
            ...
            {status.status === 'Running' && ollamaStatus.models && ollamaStatus.models.length > 0 ? (
              <>
                <div className="text-xs font-medium text-bolt-elements-textSecondary flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <Icon name="box" size={16} className="text-gray-500" />
                    ...
                    {ollamaStatus.models.map((model) => (
                      ...
                      >
                        <div className="flex items-center gap-2 text-bolt-elements-textSecondary">
                          <Icon name="box" size={16} className="text-gray-500/70 group-hover:text-gray-500 transition-colors" />
                ...
                <div className="flex flex-col items-center gap-3 max-w-[280px] text-center">
                  <div
                    className={classNames('w-12 h-12', {
                      'warning-circle text-bolt-elements-item-contentDanger/80':
                        status.status === 'Not Running' || status.status === 'Disabled',
                      'cube-duotone text-bolt-elements-textTertiary/80': status.status === 'Running',
                    })}
                  />
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor">
            <div className="flex items-center gap-3">
              <Icon name="cpu" size={20} className="text-gray-500" />
              <h3 className="text-base font-medium text-bolt-elements-textPrimary">System Information</h3>
            </div>
            <div
              className={classNames(
                'caret-down w-4 h-4 transform transition-transform duration-200',
        ...
        <CollapsibleContent>
          <div className="p-6 mt-2 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor">
            {systemInfo ? (
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="monitor" size={16} className="text-bolt-elements-textSecondary" />
                    <span className="text-bolt-elements-textSecondary">OS: </span>
                    <span className="text-bolt-elements-textPrimary">{systemInfo.os}</span>
                  </div>
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="smartphone" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="circuit-board" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="cpu" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="bar-chart-2" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="wifi" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="gauge" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  {systemInfo.battery && (
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="battery-charging" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="hard-drive" size={16} className="text-bolt-elements-textSecondary" />
                ...
                <div className="space-y-2">
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="database" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="globe" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="clock" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="languages" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="pie-chart" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="timer" size={16} className="text-bolt-elements-textSecondary" />
                  ...
                  <div className="text-sm flex items-center gap-2">
                    <Icon name="code" size={16} className="text-bolt-elements-textSecondary" />
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor">
            <div className="flex items-center gap-3">
              <Icon name="line-chart" size={20} className="text-gray-500" />
      ...
      >
        <CollapsibleTrigger className="w-full">
          <div className="flex items-center justify-between p-6 rounded-xl bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor">
            <div className="flex items-center gap-3">
              <Icon name="info" size={20} className="text-bolt-elements-item-contentAccent" />
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="layout" size={16} className="text-bolt-elements-textSecondary" />
                    ...
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="tag" size={16} className="text-bolt-elements-textSecondary" />
                    ...
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="award" size={16} className="text-bolt-elements-textSecondary" />
                    ...
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="cloud" size={16} className="text-bolt-elements-textSecondary" />
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="git-branch" size={16} className="text-bolt-elements-textSecondary" />
                    ...
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="git-commit" size={16} className="text-bolt-elements-textSecondary" />
                    ...
                    <div className="text-sm flex items-center gap-2">
                      <Icon name="user" size={16} className="text-bolt-elements-textSecondary" />
                    ...
                    {webAppInfo.gitInfo.github && (
                      <>
                        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                          <div className="text-sm flex items-center gap-2">
                            <Icon name="git-fork" size={16} className="text-bolt-elements-textSecondary" />
                          ...
                          <div className="mt-2 flex items-center gap-4 text-sm">
                            <div className="flex items-center gap-1">
                              <Icon name="star" size={2000} className="text-yello w-4" />
                              <span className="text-bolt-elements-textSecondary">
                                {webAppInfo.gitInfo.github.currentRepo.stars}
                              </span>
                            </div>
                            <div className="flex items-center gap-1">
                              <Icon name="git-fork" size={16} className="text-blue-500" />
                              <span className="text-bolt-elements-textSecondary">
              ...
              <div className="space-y-4">
                ...
                {errorLogs.length > 0 && (
                  <div className="mt-4">
                    ...
                    <div className="space-y-2">
                      {errorLogs.map((error) => (
                        <div key={error.id} className="text-sm text-bolt-elements-item-contentDanger p-2 rounded bg-bolt-elements-item-backgroundDanger/5">
