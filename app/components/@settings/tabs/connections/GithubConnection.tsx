        ...
        {!connection.user && (
          <div className="text-xs text-bolt-elements-textSecondary bg-bolt-elements-background-depth-1 dark:bg-bolt-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <Icon name="lightbulb" size={12} className=".5 .5 text-bolt-elements-icon-success dark:text-bolt-elements-icon-success" />
            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between p-4 rounded-lg bg-bolt-elements-background dark:bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor hover:border-bolt-elements-borderColorActive/70 dark:hover:border-bolt-elements-borderColorActive/70 transition-all duration-200">
                  <div className="flex items-center gap-2">
                    <Icon name="bar-chart-3" size={16} className="text-bolt-elements-item-contentAccent" />
                        ...
                        >
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                <Icon name="git-branch" size={16} className="text-bolt-elements-icon-tertiary" />
                              ...
                              <div className="flex items-center gap-3 text-xs text-bolt-elements-textSecondary">
                                <span className="flex items-center gap-1" title="Stars">
                                  <Icon name="star" size={12} className=".5 .5 text-bolt-elements-icon-warning" />
                                  {repo.stargazers_count.toLocaleString()}
                                </span>
                                <span className="flex items-center gap-1" title="Forks">
                                  <Icon name="git-fork" size={12} className=".5 .5 text-bolt-elements-icon-info" />
                            ...
                            <div className="flex items-center gap-3 text-xs text-bolt-elements-textSecondary">
                              <span className="flex items-center gap-1" title="Default Branch">
                                <Icon name="git-branch" size={12} className=".5 .5" />
                                {repo.default_branch}
                              </span>
                              <span className="flex items-center gap-1" title="Last Updated">
                                <Icon name="clock" size={12} className=".5 .5" />
                              ...
                              <span className="flex items-center gap-1 ml-auto group-hover:text-bolt-elements-item-contentAccent transition-colors">
                                <Icon name="external-link" size={12} className=".5 .5" />
                                View
                              </span>
                            </div>
                          </div>
