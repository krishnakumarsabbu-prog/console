    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2">
          <Icon name="link" size={20} className="text-bolt-elements-item-contentAccent" />
          <h2 className="text-lg font-medium text-bolt-elements-textPrimary">Connection Settings</h2>
        </div>
        <Button
          onClick={() => setShowDiagnostics(!showDiagnostics)}
          variant="outline"
          className="flex items-center gap-2 hover:bg-bolt-elements-item-backgroundActive"
        >
          {showDiagnostics ? (
            <>
      ...
      <p className="text-sm text-bolt-elements-textSecondary">Manage your external service connections and integrations</p>
      ...
      >
        <div className="p-6">
          ...
          >
            ...
            <div
              className={classNames(
                'caret-down w-4 h-4 text-bolt-elements-textSecondary transition-transform',
          ...
          {isEnvVarsExpanded && (
            <div className="mt-4">
              <p className="text-sm text-bolt-elements-textSecondary mb-2">
                ...
                <code className="px-1 py-0.5 bg-bolt-elements-background-depth-3 rounded">.env.local</code> file:
              </p>
              <div className="bg-bolt-elements-background-depth-3 p-3 rounded-md text-xs font-mono overflow-x-auto">
              ...
              <div className="mt-3 text-xs text-bolt-elements-textSecondary space-y-1">
                ...
                <ul className="list-disc list-inside pl-2 space-y-1">
                  <li>
                    ...
                    <code className="px-1 py-0.5 bg-bolt-elements-background-depth-3 rounded">
                ...
                <p className="mt-2 text-bolt-elements-textTertiary">
      ...
      <div className="text-sm text-bolt-elements-textSecondary bg-bolt-elements-background-depth-2 p-4 rounded-lg">
        <p className="flex items-center gap-1 mb-2">
          <Icon name="lightbulb" size={16} className="text-bolt-elements-item-contentSuccess" />
          <span className="font-medium text-bolt-elements-textPrimary">Troubleshooting Tip:</span>
        </p>
        <p className="mb-2">
        ...
        <ol className="list-decimal list-inside pl-4 mt-1 text-bolt-elements-textTertiary">
