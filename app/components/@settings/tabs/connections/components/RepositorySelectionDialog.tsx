      ...
      if (
        ...
        toast.error(
          <div className="space-y-2">
            <p>{errorMessage}</p>
            <button onClick={() => setShowAuthDialog(true)} className="underline font-medium block text-gray-500">
          ...
          <Dialog.Content className="fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[650px] max-h-[85vh] overflow-hidden bg-white dark:bg-bolt-elements-background-depth-1 rounded-xl shadow-xl z-[51] border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
            ...
            <div className="p-5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-gray-500/20 to-blue-500/10 flex items-center justify-center text-gray-500 shadow-sm">
              ...
              >
                <Icon name="x" size={20} className="block" />
                <span className="sr-only">Close dialog</span>
              </Dialog.Close>
            </div>

            {/* Auth Info Banner */}
            <div className="p-4 flex items-center justify-between bg-gradient-to-r from-bolt-elements-background-depth-2 to-bolt-elements-background-depth-1 dark:from-bolt-elements-background-depth-3 dark:to-bolt-elements-background-depth-2">
              ...
              <motion.button
                ...
                className="px-3 py-1.5 rounded-lg bg-gray-500 hover:bg-accent-700 text-white text-sm transition-colors flex items-center gap-1.5 shadow-sm"
              ...
              {activeTab === 'url' ? (
                <div className="space-y-5">
                  <div className="bg-gradient-to-br from-bolt-elements-background-depth-1 to-bolt-elements-background-depth-1 dark:from-bolt-elements-background-depth-2-dark dark:to-bolt-elements-background-depth-2-dark p-5 rounded-xl border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="w-full pl-10 py-3 border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark focus:ring-2 focus:ring-gray-500 focus:border-gray-200"
                      />
                    </div>
                    ...
                    <div className="mt-3 text-xs text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary-dark bg-white/50 dark:bg-bolt-elements-background-depth-4/50 p-3 rounded-lg border border-bolt-elements-borderColor/30 dark:border-bolt-elements-borderColor-dark/30 backdrop-blur-sm">
                      <p className="flex items-start gap-2">
                        <Icon name="info" size={12} className=".5 .5 flex-shrink-0 mt-0.5 text-blue-500" />
                        <span>
                  ...
                  <motion.button
                    ...
                    className={classNames(
                      ...
                      customUrl
                        ? 'bg-gradient-to-r from-gray-500 to-primary-700 hover:from-primary-700 hover:to-primary-800 shadow-md'
                ...
                <>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <div className="relative col-span-3 md:col-span-1">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-bolt-elements-textTertiary dark:text-bolt-elements-textTertiary-dark">
                                <Icon name="code" size={12} className=".5 .5" />
                              </div>
                              <input
                                type="text"
                            ...
                            <div className="relative">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-bolt-elements-textTertiary dark:text-bolt-elements-textTertiary-dark">
                                <Icon name="star" size={12} className=".5 .5" />
                              </div>
                              <input
                                type="number"
                            ...
                            <div className="relative">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-bolt-elements-textTertiary dark:text-bolt-elements-textTertiary-dark">
                                <Icon name="git-fork" size={12} className=".5 .5" />
                              </div>
                              <input
                                type="number"
                  ...
                  <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {selectedRepository ? (
                      <div className="space-y-5 bg-gradient-to-br from-gray-500/5 to-blue-500/5 p-5 rounded-xl border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark">
                        <div className="flex items-center justify-between">
                          ...
                          {selectedRepository.private && (
                            <Badge variant="primary" size="md" icon="lock w-3 h-3">
                              Private
                            </Badge>
                          )}
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          {selectedRepository.language && (
                            <Badge variant="subtle" size="md" icon="code w-3 h-3">
                              {selectedRepository.language}
                            </Badge>
                          )}
                          <Badge variant="subtle" size="md" icon="star w-3 h-3">
                            {selectedRepository.stargazers_count.toLocaleString()}
                          </Badge>
                          {selectedRepository.forks_count > 0 && (
                            <Badge variant="subtle" size="md" icon="git-fork w-3 h-3">
                        ...
                        <div className="pt-3 border-t border-bolt-elements-borderColor/30 dark:border-bolt-elements-borderColor-dark/30">
                          <div className="flex items-center gap-2 mb-2">
                            <Icon name="git-branch" size={16} className="text-gray-500" />
                          ...
                          <select
                            ...
                            className="w-full px-3 py-3 rounded-lg bg-white dark:bg-bolt-elements-background-depth-4 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-gray-500 shadow-sm"
                          >
                            {branches.map((branch) => (
                              <option
                                key={branch.name}
                        ...
                        <motion.button
                          onClick={handleImport}
                          className="w-full h-12 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-500 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white transition-all duration-200 flex items-center gap-2 justify-center shadow-md"
