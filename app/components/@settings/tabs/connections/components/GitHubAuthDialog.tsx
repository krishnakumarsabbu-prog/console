    ...
    <Dialog.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <Dialog.Portal>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[9999]">
          ...
          >
            <Dialog.Content className="bg-bolt-elements-background-depth-2 rounded-lg shadow-xl max-w-sm w-full mx-4 overflow-hidden border border-bolt-elements-borderColor">
              <div className="p-4 space-y-3">
                <h2 className="text-lg font-semibold text-bolt-elements-textPrimary">Access Private Repositories</h2>
                ...
                <div className="bg-bolt-elements-background-depth-3 p-4 rounded-lg space-y-3">
                  <h3 className="text-base font-medium text-bolt-elements-textPrimary">Connect with GitHub Token</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 rounded-lg border border-bolt-elements-borderColor bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary text-sm focus:outline-none focus:ring-1 focus:ring-bolt-elements-borderColorActive transition-all"
                      />
                    ...
                    <button
                      ...
                      className="w-full py-2 bg-gray-500 hover:bg-accent-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                    >
                ...
                <div className="bg-amber-500/10 p-3 rounded-lg space-y-1.5">
                  <h3 className="text-sm text-amber-500 font-medium flex items-center gap-1.5">
              ...
              <div className="border-t border-bolt-elements-borderColor p-3 flex justify-end">
                <Dialog.Close asChild>
                  <button
                    onClick={onClose}
                    className="px-4 py-1.5 bg-bolt-elements-background-depth-3 hover:bg-bolt-elements-item-backgroundActive rounded-lg text-bolt-elements-textPrimary transition-colors text-sm"
                  >
                    Close
                  </button>
                </Dialog.Close>
