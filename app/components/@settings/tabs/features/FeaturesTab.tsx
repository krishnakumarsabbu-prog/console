      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Icon name={feature.icon as any} className="w-5 h-5 text-bolt-elements-textSecondary" />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-bolt-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
                <span className="px-2 py-0.5 text-xs rounded-full bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent font-medium">Beta</span>
              )}
              {feature.experimental && (
                <span className="px-2 py-0.5 text-xs rounded-full bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent font-medium">
                  Experimental
                </span>
              )}
            </div>
...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <Icon name={icon as any} className="text-xl text-bolt-elements-textSecondary" />
        <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            className={classNames(
              ...
              'focus:outline-none focus:ring-2 focus:ring-bolt-elements-borderColorActive/30',
