  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-full">
        <Icon name="loader-2" size={32} className="animate-spin text-gray-500" />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-red-500 dark:text-red-400">
        <Icon name="alert-triangle" size={32} className="mb-2" />
        <p>{error}</p>
      </div>
    );
  }
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <div className={`flex items-center ${getStatusColor(service.status)}`}>
                <Icon name={getStatusIcon(service.status)} size={20} className="mr-2" />
