...
const badgeVariants = cva(
  'inline-flex items-center gap-1 transition-colors focus:outline-none focus:ring-2 focus:ring-bolt-elements-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
          'border-bolt-elements-borderColor bg-bolt-elements-background text-bolt-elements-textPrimary hover:bg-bolt-elements-background/80',
        secondary:
          'border-bolt-elements-borderColor bg-bolt-elements-background text-bolt-elements-textSecondary hover:bg-bolt-elements-background/80',
        destructive: 'border-bolt-elements-borderColor bg-red-500/10 text-red-500 hover:bg-red-500/20',
        ...
        subtle:
          'border border-bolt-elements-borderColor/30 bg-bolt-elements-background-depth-4/50 backdrop-blur-sm text-bolt-elements-textSecondary',
      },
      size: {
