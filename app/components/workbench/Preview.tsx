...
const WINDOW_SIZES: WindowSize[] = [
  { name: 'iPhone SE', width: 375, height: 667, icon: 'device-mobile', hasFrame: true, frameType: 'mobile' },
  { name: 'iPhone 12/13', width: 390, height: 844, icon: 'device-mobile', hasFrame: true, frameType: 'mobile' },
  {
  ...
  { name: 'iPad Mini', width: 768, height: 1024, icon: 'device-tablet', hasFrame: true, frameType: 'tablet' },
  { name: 'iPad Air', width: 820, height: 1180, icon: 'device-tablet', hasFrame: true, frameType: 'tablet' },
  { name: 'iPad Pro 11"', width: 834, height: 1194, icon: 'device-tablet', hasFrame: true, frameType: 'tablet' },
  {
    name: 'iPad Pro 12.9"',
    width: 1024,
    height: 1366,
...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
  ...
  const previews = useNanoStore(workbenchStore.previews);
  ...
  const expoUrl = useNanoStore(expoUrlAtom);
  ...
  const findMinPortIndex = useCallback(
    (minIndex: number, preview: any, index: number, array: any) => {
      return preview.port < (array[minIndex] as any).port ? index : minIndex;
    },
    [],
  );
  ...
  useEffect(() => {
    if (previews.length > 1 && !hasSelectedPreview.current) {
      ...
      setActivePreviewIndex(minPortIndex as any);
    }
    ...
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-bolt-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-[#1a1a1a] ring-1 ring-white/10' : ''}
          />
        </div>
        ...
        <div className="flex-grow flex items-center gap-1 bg-bolt-elements-preview-addressBar-background border border-bolt-elements-borderColor text-bolt-elements-preview-addressBar-text rounded-full px-1 py-1 text-sm hover:bg-bolt-elements-preview-addressBar-backgroundHover hover:focus-within:bg-bolt-elements-preview-addressBar-backgroundActive focus-within:bg-bolt-elements-preview-addressBar-backgroundActive focus-within-border-bolt-elements-borderColorActive focus-within:text-bolt-elements-preview-addressBar-textActive">
          <PortDropdown
            ...
            setHasSelectedPreview={(value: boolean) => (hasSelectedPreview.current = value)}
        ...
        <div className="flex items-center gap-2">
          ...
          {expoUrl && <IconButton icon="qr-code" onClick={() => setIsExpoQrModalOpen(true)} title="Show QR" />}
          ...
          {isDeviceModeOn && (
            <>
              ...
              />
              <IconButton
                icon={showDeviceFrameInPreview ? 'device-mobile' : 'device-mobile-slash'}
          ...
          <IconButton
            ...
            className={isInspectorMode ? 'bg-[#1a1a1a] ring-1 ring-accent-500/50 text-accent-400' : ''}
                  ...
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        ...
                        <Icon name="external-link" className="h-5 w-4" />
                      </button>
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-bolt-elements-textPrimary`}
                        onClick={() => {
                      ...
                      >
                        ...
                        <Icon name="globe" className="h-5 w-4" />
                      </button>
