...
import type { ElementInfo } from '../workbench/Inspector';
...
export const BaseChat = React.forwardRef<HTMLDivElement, BaseChatProps>(
  (
    ...
    const [chatWidth, setChatWidth] = useState(() => {
      if (typeof window !== 'undefined') {
        return Number(localStorage.getItem('chatWidth')) || 320;
      }
      return 320;
    });
    ...
    const baseChat = (
      ...
      >
        ...
        <div className="flex flex-row overflow-hidden w-full h-full relative z-10">
          <div
            className={classNames(styles.Chat, 'flex flex-col h-full relative overflow-hidden shrink-0 z-10')}
            style={{
              width: chatStarted ? chatWidth : '100%',
          ...
          >
            ...
            <StickToBottom
              className={classNames('pt-6 px-2 sm:px-6 relative z-10', {
          ...
          <div className="flex-1 min-w-0 flex flex-col h-full bg-transparent p-4 pl-0 pb-6 relative z-10">
            <ClientOnly>
              {() => (
