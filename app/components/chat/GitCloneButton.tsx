...
import { detectProjectCommands, createCommandsMessage, escapeCortexTags } from '~/utils/projectCommands';
...
<cortexArtifact id="imported-files" title="Git Cloned Files" type="bundled">
${fileContents
              .map(
                (file) =>
                  `<cortexAction type="file" filePath="${file.path}">
