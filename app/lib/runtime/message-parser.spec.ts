...
describe('StreamingMessageParser', () => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <cortexArtifact></cortexArtifact>', 'Foo bar <cortexArtifact></cortexArtifact>'],
      ['Before <cortexArtifact>foo</cortexArtifact> After', 'Before <cortexArtifact>foo</cortexArtifact> After'],
      ['Before <cortexArtifact>foo</cortexArtifact> After', 'Before <cortexArtifactt>foo</cortexArtifact> After'],
    ])('should correctly parse chunks and strip out bolt artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <cortexArtifact title="Some title" id="artifact_1">foo bar</cortexArtifact> Some more text',
        {
      ...
      [
        [
          ...
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</cortexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</cortexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</cortexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <cortexArtifact title="Some title" id="artifact_1">foo</cortexArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <cortexArtifact title="Some title" id="artifact_1"><cortexAction type="shell">npm install</cortexAction></cortexArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <cortexArtifact title="Some title" id="artifact_1"><cortexAction type="shell">npm install</cortexAction><cortexAction type="file" filePath="index.js">some content</cortexAction></cortexArtifact> After',
        {
          output: 'Before  After',
