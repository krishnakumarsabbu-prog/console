...
export class PreviewsStore {
  ...
  async #init() {
    ...
    if (webcontainer && typeof (webcontainer as any).on === 'function') {
      (webcontainer as any).on('server-ready', (port: number, url: string) => {
    ...
    if (webcontainer && typeof (webcontainer as any).on === 'function') {
      (webcontainer as any).on('port', (port: number, type: 'open' | 'close', url: string) => {
